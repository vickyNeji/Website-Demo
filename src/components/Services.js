...
import serviceOne from "../assets/service_one.jpeg";
import serviceTwo from "../assets/service_two.jpeg";
import serviceThree from "../assets/service_three.jpeg";
import serviceFour from "../assets/service_four.jpeg";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              ></h3>
              <p className="h-20 text-gray-400 font-bold text-sm mb-10 px-6">
                {service.description}
              </p>
