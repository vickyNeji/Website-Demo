...
import processImage from "../assets/development_process.png";
...
const StatCounter = ({ stat }) => {
  ...
  return (
    ...
    >
      ...
      {/* Icon */}
      {stat.icon && <div className="flex justify-center mb-4">{stat.icon}</div>}

      {/* Label */}
      <p className="h-35 text-gray-400 font-bold text-sm mb-10 px-6">
        {stat.label}
      </p>
    </div>
  );
  ...
  const statsData = [
    {
      ...
      label:
        "We designed high-performance custom websites that are appealing, attractive and put forth the message just as the way you want it.",
    },
    {
    ...
    },
    {
      ...
      label:
        "We craft your dream e-commerce platform on Shopify with seamless navigation, engaging design, and customized experiences for ultimate E-commerce growth.",
    },
    {
      title: "PWA",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB2sEFaDDNFETcE8Zpt5TNimBM786M9oVC3g&s",
      label:
        "We create Progressive Web Apps using modern web capabilities to deliver an app-like user experience in browser.",
    },
    {
      title: "HTML5 + CSS3 + JS",
      image:
    ...
    },
    {
      ...
      label:
        "We use React.js to build design system based, dynamic and modern front-end web apps.",
    },
    {
      title: "Node",
      image:
      ...
      label:
        "Lightweight and efficient Javascript backends for data intensive, real-time, flexible apps.",
    },
    {
      title: "React Native",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg",
      label:
        "React Native allows us to build and deploy multiplatform, native apps for Android and iOS.",
    },
  ];
  ...
  return (
    <section className="py-20 bg-gray-800">
      <div className="container mx-auto px-4 sm:px-4 ">
        ...
        <h3 className="text-base md:text-base font-medium text-white text-center mb-10">
      ...
      <div className="w-full">
        <img src={processImage} className="w-full" />
      </div>
    </section>
  );
};
